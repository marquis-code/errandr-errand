<template>
  <div v-if="showPrompt" class="fixed bottom-20 left-4 right-4 md:bottom-4 md:left-auto md:right-4 md:w-96 bg-white rounded-xl shadow-sm border border-gray-100 border border-[#FF5C1A]/20 p-4 z-50 flex flex-col gap-3">
...
import { useDispatchNotifications } from '@/composables/useDispatchNotifications'

const showPrompt = ref(false)
const loading = ref(false)
const { requestPermissionAndRegister } = useDispatchNotifications()
