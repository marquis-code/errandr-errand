<template>
 ...
 >
 <component :is="isOpen ? X : MessagesSquare" class="w-6 h-6" />
 </button>
 </div>
 </ClientOnly>
</template>
...
import { X, ArrowRight, MessagesSquare } from 'lucide-vue-next';
...
const showChatWidget = computed(() => {
 // Only show if business is loaded (riders don't have business context by default)
 return !!cachedBusiness.value
})
